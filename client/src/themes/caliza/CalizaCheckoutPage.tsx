...
export default function CalizaCheckoutPage() {
  useThemeFonts();
            ...
            <div className="min-w-0">
              ...
              <div className="grid min-w-0 gap-5 md:grid-cols-2">
                <input
                  ...
                  className="min-w-0 max-w-full rounded-xl border px-4 py-3.5 text-sm outline-none transition"
                  style={{
                    background:
              ...
              <div className="mt-5 min-w-0 space-y-5">
                ...
                <div className="min-w-0">
                  ...
                  <textarea
                    ...
                    className="block h-24 w-full min-w-0 max-w-full resize-y rounded-xl border px-4 py-3.5 text-sm outline-none transition"
                    style={{
                      background:
                        calizaColors.surface,
                      borderColor:
                ...
                <div className="min-w-0">
                  ...
                  <input
                    ...
                    className="w-full min-w-0 max-w-full rounded-xl border px-4 py-3.5 text-sm outline-none transition"
                    style={{
                      background:
                        calizaColors.surface,
                      borderColor:
            ...
            <div className="min-w-0">
              ...
              <div className="min-w-0 space-y-3">
                {[
                  ...
                  <label
                    key={method}
                    className={`flex min-w-0 cursor-pointer items-center gap-3 rounded-xl border px-4 py-3.5 transition ${
                      payment === method
                        ? ""
                        : ""
                    }`}
                    style={{
                      background:
                        payment ===
                        method
                          ? "color-mix(in srgb, #c2410c 6%, transparent)"
                          : calizaColors.surface,
                      borderColor:
                        payment ===
                        method
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      >
                        <button
                          ...
                          className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full transition hover:bg-stone-100"
