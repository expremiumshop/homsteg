...
export default function ChazucaProductPage() {
  useThemeFonts();
   ...
   * /themes/chazuca/produto/:slug?storeSlug=...
   */
  const [, routeParams] = useRoute(
    "/themes/chazuca/produto/:slug",
  );
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1200px] px-5 py-8 md:px-8 md:py-12">
        ...
        {!storeSlug && (
          <div
            className="mt-14 rounded-3xl border p-6 text-sm"
            style={{
              borderColor:
                chazucaColors.border,
              color:
