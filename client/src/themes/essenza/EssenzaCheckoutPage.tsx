...
export default function EssenzaCheckoutPage() {
  useThemeFonts();
...
━━━━━━━━━━━━━━━━━━━━
  ...
  if (cart.length === 0) {
    return (
      <main className="flex min-h-screen min-w-0 items-center justify-center bg-white p-6">
        <div className="w-full min-w-0 max-w-md text-center">
          <h1
            className="break-words text-3xl text-neutral-950"
            style={{
              fontFamily:
          ...
          <Link
            ...
            className="mt-7 inline-block border border-neutral-950 px-7 py-3 text-[11px] font-semibold uppercase tracking-[0.18em] text-neutral-950 transition hover:bg-neutral-950 hover:text-white"
          >
            Voltar para loja
          </Link>
        </div>
        ...
        <div className="grid min-w-0 gap-12 lg:grid-cols-3">
          ...
          <section className="min-w-0 space-y-10 lg:col-span-2">
            ...
            <div className="min-w-0">
              <h2 className="mb-6 flex min-w-0 items-center gap-2.5 text-sm font-semibold uppercase tracking-[0.16em] text-neutral-950">
                <MapPin
                  size={17}
                  strokeWidth={1.5}
                  className="shrink-0"
              ...
              <div className="grid min-w-0 gap-5 md:grid-cols-2">
                <input
                  ...
                  className="min-w-0 max-w-full border border-neutral-200 px-4 py-3.5 text-sm outline-none transition placeholder:text-neutral-400 focus:border-neutral-950"
                />
              ...
              <div className="mt-5 min-w-0 space-y-5">
                ...
                <div className="min-w-0">
                  <label className="mb-2 block text-[11px] font-semibold uppercase tracking-[0.14em] text-neutral-950">
                    Endereço 1
                  </label>
                  ...
                  <textarea
                    ...
                    className="block h-24 w-full min-w-0 max-w-full resize-y border border-neutral-200 px-4 py-3.5 text-sm outline-none transition placeholder:text-neutral-400 focus:border-neutral-950"
                  />
                ...
                <div className="min-w-0">
                  ...
                  <input
                    ...
                    className="w-full min-w-0 max-w-full border border-neutral-200 px-4 py-3.5 text-sm outline-none transition placeholder:text-neutral-400 focus:border-neutral-950"
                  />
                </div>
            ...
            <div className="min-w-0">
              ...
              <div className="min-w-0 space-y-3">
                {[
                  ...
                  <label
                    key={method}
                    className={`flex min-w-0 cursor-pointer items-center gap-3 border px-4 py-3.5 transition ${
                      payment === method
                  ...
                  >
                    ...
                    <span className="min-w-0 break-words text-sm text-neutral-900">
                      {method}
                    </span>
                  </label>
                ))}
          ...
          <aside className="h-fit min-w-0 border border-neutral-200 p-7 lg:sticky lg:top-28">
            <h2
              className="mb-6 min-w-0 break-words text-xl text-neutral-950"
              style={{
                fontFamily:
                  "'Playfair Display', Georgia, serif",
                fontWeight: 500,
                ...
                return (
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      <h3 className="min-w-0 max-w-full break-words text-sm font-medium text-neutral-950 [overflow-wrap:anywhere]">
                        {item.name}
                      </h3>
                      ...
                      {variantsText && (
                        <p className="mt-1 min-w-0 max-w-full break-words text-xs text-neutral-400 [overflow-wrap:anywhere]">
                          {variantsText.split("\n").join(" · ")}
                        </p>
                      )}
                      ...
                      <div className="mt-2.5 flex items-center border border-neutral-200">
                        <button
                          type="button"
                          onClick={() =>
                            decreaseQuantity(
                          ...
                          className="flex h-8 w-8 shrink-0 items-center justify-center transition hover:bg-neutral-50"
                    ...
                    <div className="flex min-w-0 shrink-0 flex-col items-end justify-between">
                      <strong className="max-w-[90px] break-words text-right text-sm font-medium text-neutral-950">
                        {formatPrice(
                          subtotal,
                        )}
                      </strong>
                      ...
                      <button
                        ...
                        className="p-1.5 text-neutral-400 transition hover:text-red-600"
            ...
            <div className="mt-5 min-w-0 space-y-3 border-t border-neutral-200 pt-5">
              ...
              <div className="flex min-w-0 items-center justify-between gap-4 text-sm">
                ...
                <strong className="shrink-0 font-medium text-neutral-950">
                  Grátis
                </strong>
              </div>

              <div className="flex min-w-0 items-center justify-between gap-4 pt-1 text-base font-medium text-neutral-950">
            ...
            <button
              ...
              disabled={loading}
              className="mt-7 flex min-h-14 w-full min-w-0 items-center justify-center gap-3 bg-[#25D366] px-4 py-4 text-center text-[11px] font-semibold uppercase tracking-[0.14em] text-white transition hover:bg-[#1fb857] disabled:cursor-not-allowed disabled:opacity-60"
            >
              <MessageCircle
                size={18}
                className="shrink-0"
            ...
            <p className="mt-3 min-w-0 max-w-full break-words text-center text-xs text-neutral-400">
