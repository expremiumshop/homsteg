...
export default function LuxeAccountPage() {
      ...
      content: (
        <div className="space-y-4">
          <p>
            ...
            selecionados e verificados para
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-xl bg-slate-950 px-4 py-3.5 text-sm font-bold text-white transition hover:bg-red-500 disabled:cursor-not-allowed disabled:opacity-50"
          >
    ...
    <main className="min-h-screen bg-[#f7f7f5] px-4 py-8 md:px-6 md:py-12">
      <div className="mx-auto w-full max-w-3xl">
        <section className="overflow-hidden rounded-2xl border border-slate-200 bg-white">
          ...
          {/* SEÇÕES */}
          <div className="space-y-2.5 px-6 py-7 md:px-8">
            {sections.map(
              (section, index) => {
                const Icon =
                  section.icon;
          ...
          {/* VOLTAR */}
          <div className="border-t border-slate-200 px-6 py-7 text-center md:px-8">
            <Link
              href={storePath}
              className="inline-flex items-center justify-center rounded-xl bg-slate-950 px-7 py-3.5 text-sm font-bold text-white transition hover:bg-red-500"
            >
              Voltar à loja
            </Link>
          </div>
