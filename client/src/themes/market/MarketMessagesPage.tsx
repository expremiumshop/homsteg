    ...
    <main className="min-h-screen bg-slate-50 px-4 py-8 md:px-6 md:py-12">
      <div className="mx-auto w-full max-w-3xl">
        <section className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
          ...
          <div className="flex items-center gap-3.5 border-b border-slate-100 px-6 py-7 md:px-8">
          ...
          <div className="space-y-6 px-6 pb-8 md:px-8">
            ...
            <div className="rounded-2xl bg-[#0b3d2e] p-6 text-white">
              ...
              <button
                ...
                className="mt-5 flex w-full items-center justify-center gap-2 rounded-xl bg-emerald-500 px-5 py-3.5 text-sm font-black text-white transition hover:bg-emerald-600 disabled:cursor-not-allowed disabled:opacity-50"
              >
