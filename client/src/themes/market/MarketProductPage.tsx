...
export default function MarketProductPage() {
   ...
   * /themes/market/produto/:slug?storeSlug=...
   */
  const [, routeParams] = useRoute(
    "/themes/market/produto/:slug",
  );
    ...
    return (
      <main className="flex min-h-screen items-center justify-center bg-slate-50 px-4">
        <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-8 text-center">
          ...
          <Link
            href="/"
            className="mt-6 inline-flex items-center justify-center rounded-xl bg-emerald-600 px-6 py-3 text-sm font-black text-white transition hover:bg-emerald-700"
          >
            Voltar
          </Link>
        </div>
  ...
  return (
    <main className="min-h-screen bg-slate-50 pb-24">
      <div className="mx-auto max-w-[1200px] px-4 py-6 md:px-6 md:py-10">
        ...
        <div className="grid grid-cols-1 gap-8 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm md:p-8 lg:grid-cols-2 lg:gap-12">
          {/* GALERIA */}
