      ...
      content: (
        <div className="space-y-4">
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-xl bg-slate-950 px-4 py-3.5 text-sm font-bold text-white transition hover:bg-orange-500 disabled:cursor-not-allowed disabled:opacity-50"
          >
      ...
      <div className="mx-auto w-full max-w-3xl">
        <section className="overflow-hidden rounded-3xl bg-white shadow-sm">
          ...
          <div className="px-6 pb-8 text-center md:px-8">
            <Link
              href={storePath}
              className="inline-flex items-center justify-center rounded-xl bg-slate-950 px-7 py-3.5 text-sm font-bold text-white transition hover:bg-orange-500"
            >
              Voltar à loja
            </Link>
          </div>
