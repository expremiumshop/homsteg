...
export default function PrimeMessagesPage() {
  ...
  return (
    <main className="min-h-screen bg-[#f7f7f8] px-4 py-8 md:px-6 md:py-12">
          ...
          <div className="space-y-6 px-6 pb-8 md:px-8">
            ...
            <div className="space-y-2.5">
              <div className="flex items-start gap-3 rounded-2xl bg-slate-50 p-5">
                <ShoppingBag className="mt-0.5 h-5 w-5 shrink-0 text-orange-500" />
              ...
              <div className="flex items-start gap-3 rounded-2xl bg-slate-50 p-5">
                <HelpCircle className="mt-0.5 h-5 w-5 shrink-0 text-orange-500" />
            ...
            <div className="rounded-2xl bg-slate-950 p-6 text-white">
              ...
              <button
                ...
                className="mt-5 flex w-full items-center justify-center gap-2 rounded-xl bg-orange-500 px-5 py-3.5 text-sm font-black text-white transition hover:bg-orange-600 disabled:cursor-not-allowed disabled:opacity-50"
              >
