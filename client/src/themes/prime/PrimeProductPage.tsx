...
export default function PrimeProductPage() {
  const [, setLocation] =
    useLocation();
  ...
  const product: PrimePageProduct | undefined =
    useMemo(() => {
      if (!rawProduct) {
        return undefined;
      }
  ...
  return (
    <main className="min-h-screen bg-[#f7f7f8] pb-24">
      <div className="mx-auto max-w-[1200px] px-4 py-6 md:px-6 md:py-10">
        ...
        {/* PRODUTO */}
        <div className="grid grid-cols-1 gap-8 rounded-3xl bg-white p-4 shadow-sm md:p-8 lg:grid-cols-2 lg:gap-12">
          {/* GALERIA */}
        ...
        {!storeSlug && (
          <div className="mt-10 rounded-3xl bg-white p-6 text-sm text-slate-500 shadow-sm">
